...
<body>
    <form id="form1" runat="server">
        ...
        <div class="contenedor">
            <h1 style="font-size: x-large">Análisis de Pacientes con Alta Tasa de Cancelaciones </h1>

            <!-- Filtro -->
            <div class="form-grupo">
                <asp:DropDownList ID="ddlOrden" runat="server" CssClass="selector-mes" AutoPostBack="True">
                </asp:DropDownList>
                <asp:Button ID="btnMostrarTodos" runat="server" CssClass="btn" Text="Mostrar todos los pacientes" OnClick="btnMostrarTodos_Click"/>
            </div>
