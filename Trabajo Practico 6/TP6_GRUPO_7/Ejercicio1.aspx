    ...
    <form id="form1" runat="server">
        <div class="contenedor">
            ...
            <asp:GridView ID="gvProductos" runat="server" CssClass="grid-view" AllowPaging="True" 
                ...
                PageSize="10" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowDeleting="gvProductos_RowDeleting" OnRowCancelingEdit="gvProductos_RowCancelingEdit" OnRowEditing="gvProductos_RowEditing">
